            ...
            <div class="col-xs-6-offset-3">
                 ...
                 <table class="table table-responsive ">
                    <tr>
                        ...
                        <th> <input placeholder="<?php echo ((isset($objDventa) == FALSE) ? i18n::__('item', NULL, 'dpVenta') : $objDventa[0]->$id = ucwords($objDventa[0]->$id)) ?>" type="text" name="<?php echo dpVentaTableClass::getNameField(dpVentaTableClass::ID, true) ?>" ></th>   
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <th> <input placeholder="<?php echo ((isset($objDventa) == FALSE) ? i18n::__('numer', NULL, 'dpVenta') : $objDventa[0]->$numero_documento = ucwords($objDventa[0]->$numero_documento)) ?>" type="text" name="<?php echo dpVentaTableClass::getNameField(dpVentaTableClass::NUMERO_DOCUMENTO, true) ?>" ></th>   
                    </tr>
                      <tr>
                        <th>
                    ...
                    <tr>
                        <th>  <?php echo i18n::__('animal_id', NULL, 'dpVenta') ?>:</th>
                        <th> <input placeholder="<?php echo ((isset($objDventa) == FALSE) ? i18n::__('animal_id', NULL, 'dpVenta') : $objDventa[0]->$animal_id = ucwords($objDventa[0]->$animal_id)) ?>" type="text" name="<?php echo dpVentaTableClass::getNameField(dpVentaTableClass::ANIMAL_ID, true) ?>" ></th>   
                    </tr>
