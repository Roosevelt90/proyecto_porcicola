    ...
    <form id="frmDeleteAll" action="<?php echo routing::getInstance()->getUrlWeb('animal', 'deleteSelectRaza') ?>" method="POST">
        <div class="row">
            <div class="col-xs-4-offset-4 nuevo">
                ...
                <a id="new" href="<?php echo routing::getInstance()->getUrlWeb('animal', 'insertRaza') ?>" class="btn btn-success btn-xs">   <?php echo i18n::__('nuev') ?></a>
            ...
            <tbody>
                <?php foreach ($objRaza as $key): ?>
                    <tr>
                        ...
                        <td>
                            <a  id="editar<?php echo $countDetale ?>" href="<?php echo routing::getInstance()->getUrlWeb('animal', 'editRaza', array(razaTableClass::ID => $key->$id)) ?>" class="btn btn-info  btn-sm"><?php echo i18n::__('modify', NULL, 'user') ?></a>
