    ...
    <form>
        <div class="row">
            <div class=" col-xs-12 text-center">
                <a href="<?php echo routing::getInstance()->getUrlWeb('personal', 'insertEmpleado') ?>" class="btn btn-success btn-xs"> <?php echo i18n::__('new', null, 'empleado') ?></a>
        ...
        <tbody>
            <?php foreach ($objEmpleado as $key): ?>
                <tr>
                    ...
                    <td>
                        <a href="<?php echo routing::getInstance()->getUrlWeb('personal', 'editEmpleado', array(empleadoTableClass::ID => $key->$id)) ?>" class="btn btn-info  btn-sm"><?php echo i18n::__('edit', null, 'empleado') ?></a>
