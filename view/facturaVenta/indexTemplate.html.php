                        ...
                        <?php foreach ($objFacturaVenta as $key): ?>
                          <tr> 
                              ...
                              <td>  
                                  ...
                                  <a id="inhabilitar<?php echo $countDetale ?>" onclick="myModalDisable(<?php echo $key->$id ?>, '<?php echo procesoVentaTableClass::getNameField(procesoVentaTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('factura', 'deleteFacturaVenta') ?>')" href="#" class="btn btn-sm btn-default fa fa-ban" data-toggle="modal" data-target=""></a>
                                    <div class="mdl-tooltip mdl-tooltip--large" for="inhabilitar<?php echo $countDetale ?>">
                                      <?php echo i18n::__('inhFactura', null, 'ayuda') ?>
                                  </div> 
                                  <a id="insertDetalle<?php echo $countDetale ?>" href="#" class="btn btn-sm btn-primary fa fa-bars" data-toggle="modal" data-target="#myModalDetail<?php echo $key->$id ?>" class="btn btn-info btn-xs"></a>
                                  ...
                                  <a id="habilitar<?php echo $countDetale ?>"  onclick="myModalEnable(<?php echo $key->$id ?>, '<?php echo procesoVentaTableClass::getNameField(procesoVentaTableClass::ID, true) ?>', '<?php echo routing::getInstance()->getUrlWeb('factura', 'deleteFacturaVenta') ?>')" href="#" class="btn btn-sm btn-info active fa fa-exchange" data-toggle="modal" data-target=""></a>
